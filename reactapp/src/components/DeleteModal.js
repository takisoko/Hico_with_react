...
export function DeleteModal({ id, DeleteData, type, name }) {
    ...
    return (
        <div>
            <Button sx={{ textTransform: 'none' }} onClick={handleOpen}> <IconTrash/> </Button>
            <Modal open={open} onClose={handleClose}>
                <Box sx={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', bgcolor: 'background.paper', boxShadow: 24, p: 4, width: '50vw', maxWidth: 500 }}>
                    ...
                    <Divider sx={{ my: 2 }} />
                    <Typography variant="Body2" component="Body2">Are you sure you want to delete "{name}" {type}?</Typography>
